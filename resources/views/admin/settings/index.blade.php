                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">{{ app()->getLocale() === 'ar' ? 'حدد أيام وأوقات العمل من صفحة الجدول' : 'Set working days & hours from the schedule page' }}</p>
                            </div>
                            <a href="{{ route('dashboard.doctors.schedule', $doctor) }}" class="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-indigo-700 bg-indigo-50 border border-indigo-200 rounded-xl hover:bg-indigo-100 transition-all">
