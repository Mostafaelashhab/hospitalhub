        ...
        <div class="w-full lg:w-1/2 flex flex-col">
            ...
            <div class="flex-1 flex items-center justify-center px-6 py-8 lg:px-12">
                <div class="w-full max-w-md">
                    ...
                    {{-- Phone Login --}}
                    <a href="{{ route('otp.login') }}" class="w-full py-3.5 bg-emerald-600/10 text-emerald-400 font-semibold rounded-xl hover:bg-emerald-600/20 transition-all border border-emerald-600/30 flex items-center justify-center gap-2 mb-3">
                        ...
                        @if(app()->getLocale()==='ar') الدخول بالواتساب @else Login with WhatsApp @endif
                    </a>
