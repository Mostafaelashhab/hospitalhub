<x-dashboard-layout>
    ...
    <x-slot name="sidebar">
        <a href="{{ route('super.dashboard') }}" class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-all duration-200">
        ...
        <a href="{{ route('super.clinics.index') }}" class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl nav-link-active transition-all duration-200">
