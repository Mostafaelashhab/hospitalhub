@php $active = $active ?? ''; $user = auth()->user(); @endphp
...
{{-- Doctors (admin only) --}}
@if($user->isAdmin() && $user->hasPermission('doctors.view'))
...
@if($user->isAdmin() && $user->hasPermission('invoices.view'))
...
@if($user->isAdmin() && $user->hasPermission('permissions.manage'))
