            ...
            <div class="text-center max-w-4xl mx-auto mb-16">
                ...
                <div class="fade-up d4 flex items-center justify-center gap-8 flex-wrap">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm text-indigo-300 font-medium">500+ {{ app()->getLocale()==='ar' ? 'عيادة أسنان' : 'Dental Clinics' }}</span>
                    </div>
                        ...
                        <div class="flex-1 bg-gray-50 p-4 md:p-6 min-h-[350px] md:min-h-[420px]">
                            ...
                            <div class="flex items-center justify-between mb-5">
                                <div>
                                    ...
                                    <p class="text-[10px] md:text-xs text-gray-400">{{ app()->getLocale()==='ar' ? 'عيادة سمايل للأسنان — الفرع الرئيسي' : 'Smile Dental Clinic — Main Branch' }}</p>
                                </div>
                                <div class="flex items-center gap-2">
    ...
    <section id="specialties" class="py-24 md:py-32 bg-white overflow-hidden">
        ...
        <div class="relative overflow-hidden">
            <div class="flex gap-4 marquee-track" style="width:max-content">
                @for($r=0;$r<2;$r++)
                <div class="flex items-center gap-3 bg-cyan-50 border border-cyan-100 rounded-2xl px-6 py-4 shrink-0 hover:shadow-lg hover:scale-105 transition-all cursor-default"><div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm text-xl">🦷</div><span class="text-sm font-bold text-gray-700 whitespace-nowrap">{{ app()->getLocale()==='ar' ? 'حشوات' : 'Fillings' }}</span></div>
                <div class="flex items-center gap-3 bg-blue-50 border border-blue-100 rounded-2xl px-6 py-4 shrink-0 hover:shadow-lg hover:scale-105 transition-all cursor-default"><div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm text-xl">🔩</div><span class="text-sm font-bold text-gray-700 whitespace-nowrap">{{ app()->getLocale()==='ar' ? 'زراعة أسنان' : 'Dental Implants' }}</span></div>
                <div class="flex items-center gap-3 bg-purple-50 border border-purple-100 rounded-2xl px-6 py-4 shrink-0 hover:shadow-lg hover:scale-105 transition-all cursor-default"><div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm text-xl">😁</div><span class="text-sm font-bold text-gray-700 whitespace-nowrap">{{ app()->getLocale()==='ar' ? 'تقويم أسنان' : 'Orthodontics' }}</span></div>
                <div class="flex items-center gap-3 bg-amber-50 border border-amber-100 rounded-2xl px-6 py-4 shrink-0 hover:shadow-lg hover:scale-105 transition-all cursor-default"><div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm text-xl">👑</div><span class="text-sm font-bold text-gray-700 whitespace-nowrap">{{ app()->getLocale()==='ar' ? 'تركيبات وتيجان' : 'Crowns & Bridges' }}</span></div>
                <div class="flex items-center gap-3 bg-red-50 border border-red-100 rounded-2xl px-6 py-4 shrink-0 hover:shadow-lg hover:scale-105 transition-all cursor-default"><div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm text-xl">🔬</div><span class="text-sm font-bold text-gray-700 whitespace-nowrap">{{ app()->getLocale()==='ar' ? 'علاج جذور' : 'Root Canal' }}</span></div>
                <div class="flex items-center gap-3 bg-emerald-50 border border-emerald-100 rounded-2xl px-6 py-4 shrink-0 hover:shadow-lg hover:scale-105 transition-all cursor-default"><div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm text-xl">✨</div><span class="text-sm font-bold text-gray-700 whitespace-nowrap">{{ app()->getLocale()==='ar' ? 'تبييض أسنان' : 'Teeth Whitening' }}</span></div>
                <div class="flex items-center gap-3 bg-pink-50 border border-pink-100 rounded-2xl px-6 py-4 shrink-0 hover:shadow-lg hover:scale-105 transition-all cursor-default"><div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm text-xl">💎</div><span class="text-sm font-bold text-gray-700 whitespace-nowrap">{{ app()->getLocale()==='ar' ? 'فينيرز' : 'Veneers' }}</span></div>
                <div class="flex items-center gap-3 bg-indigo-50 border border-indigo-100 rounded-2xl px-6 py-4 shrink-0 hover:shadow-lg hover:scale-105 transition-all cursor-default"><div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm text-xl">🧹</div><span class="text-sm font-bold text-gray-700 whitespace-nowrap">{{ app()->getLocale()==='ar' ? 'تنظيف وتلميع' : 'Cleaning & Polishing' }}</span></div>
                <div class="flex items-center gap-3 bg-teal-50 border border-teal-100 rounded-2xl px-6 py-4 shrink-0 hover:shadow-lg hover:scale-105 transition-all cursor-default"><div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm text-xl">🏥</div><span class="text-sm font-bold text-gray-700 whitespace-nowrap">{{ app()->getLocale()==='ar' ? 'جراحة فم' : 'Oral Surgery' }}</span></div>
                <div class="flex items-center gap-3 bg-orange-50 border border-orange-100 rounded-2xl px-6 py-4 shrink-0 hover:shadow-lg hover:scale-105 transition-all cursor-default"><div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm text-xl">👶</div><span class="text-sm font-bold text-gray-700 whitespace-nowrap">{{ app()->getLocale()==='ar' ? 'أسنان أطفال' : 'Pediatric Dentistry' }}</span></div>
                @endfor
            </div>
        </div>
    </section>
